export const sPrompt_Reasoning_Action_Feedback = `
As an AI assistant, your task is to analyze changes in pages before and after the execution of automation code, represented in terms of 'beforepage', 'afterpage', 'beforePageSummary', and 'afterPageSummary'.
...
{
    "beforepage": "https://example.com/articles",
    "afterpage": "https://example.com/articles/tech-news-latest",
    "beforePageSummary": {
        "appPurpose": "News portal",
...
{
    "beforepage": "https://example.com/about",
    "afterpage": "https://example.com/about#footer",
    "beforePageSummary": {
        "appPurpose": "Corporate website",
...
{
    "beforepage": "https://example.com/search",
    "afterpage": "https://example.com/search?q=Playwright",
    "beforePageSummary": {
        "appPurpose": "Search engine",
...
{
    "beforepage": "https://example.com/login",
    "afterpage": "https://example.com/profile",
    "beforePageSummary": {
        "appPurpose": "Online service platform",
